      ...
      <View style={styles.textContainer}>
        <View
          ...
          <Text style={{ ...AppStyles.smallText, color: colors.primaryBlue }}>
            {packageData?.servicedata?.duration} Mins
          </Text>
        </View>
        <Text style={{ ...AppStyles.regularText, marginBottom: 5 }}></Text>
        <View style={styles.dotContainer}>
          {packageData?.servicedata?.title ? <View style={styles.dot} /> : null}
          <Text style={{ ...AppStyles.medium }}>
            {packageData?.servicedata?.title || ''}
          </Text>
        </View>
        <View style={styles.dotContainer}>
          {packageData?.servicedata?.productInfo ? (
        ...
        <>
          ...
          <View
            ...
            <Icon
              ...
              type="FontAwesome5"
            />
            <Text style={{ ...AppStyles.regularText, marginHorizontal: 4 }}>
              1000
            </Text>
          </View>
        </>
            ...
            <View>
              <View
                ...
                <Text
                  ...
                  {packageData?.servicedata?.netPrice}
                </Text>
              </View>
...
const styles = StyleSheet.create({
  edit: {
    ...
    paddingVertical: 6,
    backgroundColor: 'rgba(13, 131, 238,.13)',
  },
  plusBtn: {
    flexDirection: 'row',
    alignItems: 'center',
